...
public class Program {
	...
	private static void init() {
		...
		lion = new Lion("Simba");
		animals.add(lion);
		bear = new Bear("Baloo", new Point(20, 60));
		animals.add(bear);
		elephant = new Elephant("Dumbo",new Point(3, 5), 2);
		animals.add(elephant);
		giraffe = new Giraffe("Melman", new Point(7, 7), 2);
		animals.add(giraffe);
		turtle = new Turtle("Rafael",new Point(60, 60));
		animals.add(turtle);
		animals.add(new Bear("Ted", new Point(13, 500)));
